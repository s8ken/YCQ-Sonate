...
const AssistantDetail = () => {
  ...
  const availableModels = ["gpt-4-1106-preview", "gpt-4-turbo-preview", "gpt-4", "gpt-3.5-turbo-1106", "gpt-3.5-turbo"]
      ...
      <Box sx={{ display: "flex", alignItems: "center", mb: 3 }}>
        ...
        <Box>
          ...
          <Typography variant="body1" color="text.secondary">
            {isNewAssistant
              ? "Create a new OpenAI Assistant with access to your app data"
              : "Modify your assistant configuration"}
          </Typography>
        </Box>
      </Box>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                <FormControl fullWidth margin="normal">
                  ...
                  <Select name="model" value={assistant.model} onChange={handleChange} label="Model">
